"""C-track (50k capital) grid — replay the 2026 shadow window on the full panel.

Follows the A/B optimization route: the short leg was pure drag in 2026
(long-only won decisively), 10d rebalance beat 20d, and small capital needs
cost governance (notional_floor + band_frac). This grid varies the book size,
rebalance cadence and governance knobs for 50,000 RMB.
"""
...
VARIANTS = [
    {"label": "C_5_0_gov_rb10",   "cash": 50_000, "long_pct": 0.05, "short_pct": 0.0,
     "rebalance_days": 10, "notional_floor": 2000, "band_frac": 0.001},
    {"label": "C_5_0_gov_rb20",   "cash": 50_000, "long_pct": 0.05, "short_pct": 0.0,
     "rebalance_days": 20, "notional_floor": 2000, "band_frac": 0.001},
    {"label": "C_4_0_gov_rb10",   "cash": 50_000, "long_pct": 0.04, "short_pct": 0.0,
     "rebalance_days": 10, "notional_floor": 2000, "band_frac": 0.001},
    {"label": "C_3_0_gov_rb10",   "cash": 50_000, "long_pct": 0.03, "short_pct": 0.0,
     "rebalance_days": 10, "notional_floor": 2000, "band_frac": 0.001},
    {"label": "C_5_0_rb10_f1000", "cash": 50_000, "long_pct": 0.05, "short_pct": 0.0,
     "rebalance_days": 10, "notional_floor": 1000, "band_frac": 0.001},
    {"label": "C_5_0_rb10_band0", "cash": 50_000, "long_pct": 0.05, "short_pct": 0.0,
     "rebalance_days": 10, "notional_floor": 2000, "band_frac": 0.0},
]
...
def main() -> int:
    ...
    for v in VARIANTS:
        ...
        ledger_path = ROOT / "outputs" / f"_ctune_{v['label']}.sqlite"
