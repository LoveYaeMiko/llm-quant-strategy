"""D-track grid v6 — intraday stop execution on/off at cap 0.40.
...
VARIANTS = {
    "D_cap40_close": {"intraday": False},
    "D_cap40_intraday": {"intraday": True},
    "D_cap50_intraday": {"intraday": True, "cap": 0.50},
}
...
def main() -> int:
    ...
    out_path = ROOT / "outputs" / "d_track_grid6.json"
